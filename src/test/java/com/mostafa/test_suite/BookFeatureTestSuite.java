 ...
 */
@Suite
@SelectClasses({BookControllerIT.class, BookServiceIT.class, BookRepositoryIT.class})
//@SelectPackages({"com.mostafa.controller", "com.mostafa.service", "com.mostafa.repository"})
//@IncludeClassNamePatterns({"^.*IT?$"})
public class BookFeatureTestSuite {
}
